# Graph Report - kindix-ai-platform  (2026-09-04)

## Corpus Check
- 35 files · ~83,374 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 283 nodes · 338 edges · 20 communities (19 shown, 1 thin omitted)
...
Cohesion: 0.11
Nodes (21): KnowledgeChunk, Column, Entity, PrimaryGeneratedColumn, KnowledgeItem, Column, Entity, PrimaryGeneratedColumn (+13 more)
...
## Knowledge Gaps
- **116 isolated node(s):** `$schema`, `collection`, `sourceRoot`, `deleteOutDir`, `name` (+111 more)
